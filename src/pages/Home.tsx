...
const Home: React.FC = () => {
  ...
  const { items, isLoading, selectedCategory } = useSelector(
  ...
  return (
    <div className="home">
      ...
      <p>
        Jako drużynowy miałem przyjemność przyjmować wielu chłopaków do drużyny.
        Każdy nowy harcerz potrzebuje munduru, a z drugiej strony wielu druhów i
        ja sam przez lata wyrosłem z wielu mundurów. Za małe mundury lądowały na
        dnie szafy, a przecież wcale tak nie musi być.
      </p>
      <p>
        Harcdzielnia to przestrzeń wymiany – każdy może oddać mundur i dać mu
        szansę na drugie życie lub w spisie znaleźć coś dla siebie, za darmo
        odebrać i uratować przed kurzem i zapomnieniem.
      </p>
      ...
      <p>
        ...
        , a twój mundur będzie widoczny dla wszystkich odwiedzających
        harcdzielnię. W wiadomości podaj proszę dane kontaktowe (mail/numer
        tel.), żebyśmy mogli umówić się na przekazanie munduru i zrobić miejsce
        w Twojej szafie.
      </p>

      <h3>Szukam używanego munduru</h3>
      <p>
        Poniżej znajduje się lista zebranych części umundurowania. Jeżeli
        znajdziesz poniżej coś dla siebie skontaktuj się przez dane kontaktowe
        (znajdziesz je na stronie munduru, po kliknięciu w "kafelek")
      </p>
      ...
      {isLoading ? (
        ...
        <div className="container">
          <span>Tutaj jeszcze nic nie ma...</span>
        </div>
      ) : (
        <div className="container">
